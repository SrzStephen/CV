                ...
                <div className="resume-wrapper-inner mx-auto text-left bg-white shadow-lg">
                    ...
                    <div className="resume-body p-4" style={{backgroundImage: `url(${Lines})`, overflow: 'hidden'}}>
                        ...
                        <section className="resume-section summary-section mb-5">
                            ...
                            <div
                                className="resume-section-content">{htmlToReactParser.parse(props.data.summary.html)}</div>
                        </section>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-3" style={{marginTop: '40px'}}>
                                <section className="resume-section skills-section mb-5">
                                    ...
                                    <div className="resume-section-content">
                                        <ResumeSkillList skills={props.data.skills.nodes[0].childSkillsJson.languages}
                                                         title={'Languages and Frameworks'}/>
                                        <ResumeSkillList skills={props.data.skills.nodes[0].childSkillsJson.tools}
                                ...
                                <section className="resume-section education-section mb-5">
                                    ...
                                    <div className="resume-section-content">
                                        <EducationList
                                            educations={props.data.educations.nodes[0].childEducationsJson.educations}/>
                                    </div>
                                </section>
                                <section className="resume-section reference-section mb-5">
                                    ...
                                    <div className="resume-section-content">
                                        <CertificationList
                                            certifications={props.data.certs.nodes[0].childCertsJson.certs}/>
                                    </div>
                                </section>
                            </div>
                        </div>
