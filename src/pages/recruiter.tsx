                ...
                <div className="resume-wrapper-inner mx-auto text-left bg-white shadow-lg">
                    ...
                    <div className="resume-body p-4" style={{backgroundImage: `url(${Lines})`, overflow: 'hidden'}}>
                        <section className="resume-section summary-section mb-5">
                            ...
                            <div
                                className="resume-position-title-no-link mb-1">
                                <p>
                                    Hi, thanks for reaching out.
                                    <br/>
                                    Please excuse the generic response; I get a lot of messages from recruiters who are
                                ...
                                <ul className="resume-awards-list" style={{marginLeft: '17px'}}>
                                    ...
                                    <li>The technologies that form their core tech stack (Eg: Python, Java, Flask,
                                        React)
                                    </li>
                                    <li>The nature of the position (contract or permanent)</li>
                                    <li>The length of contract if it's a contract position</li>
                                    <li>The job title (e.g. "Principal Engineer")</li>
                                    <li>A rough salary/contract rate range, and whether or not this figure includes
                                        superannuation
                                    </li>
                            ...
                            <h2 className="resume-section-title font-weight-bold pb-3 mb-3">
                                ...
                                My CV is publicly available at <OutboundLink className="resume-award-name link-unstyled"
                                                                             href={props.data.social.nodes[0].childSocialJson.social.cv}>{props.data.social.nodes[0].childSocialJson.social.cv.slice(8)}</OutboundLink>
                            </div>
